...
march_2015_ds = ds.sel(time_counter=(ds.time_counter.dt.year == 2015) & (ds.time_counter.dt.month == 3))
...
print("March 2015 Sea Surface Height Anomaly (m) relative to 1995–2014 full-period mean:")
