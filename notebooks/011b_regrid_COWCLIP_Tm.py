...
# 🔧 Example usage
directory_path = "../data/COWCLIP/Tm"
inspect_netcdf_files(directory_path, recursive=True)


# %%
ds = xr.open_dataset(
    "../data/COWCLIP/Tm/Tm_JRC-ERAI_annual_1980-2014.nc", decode_times=False
)
...
ds.to_netcdf("../data/COWCLIP/Tm/tm_JRC-ERAI_annual_1980-2014_fixed.nc")
...
animate_nc_file(
    "../data/COWCLIP/Tm/Tm_GOW2_annual_1980-2014.nc",
    save_path="../data/COWCLIP/Tm/movie/Tm_GOW2_annual_1980-2014.gif",
)
...
input_directory = "../data/COWCLIP/Tm"
...
check_regridding(
    "/Users/tessamoeller/Documents/atoll_paper/data/COWCLIP/Tm",
    "/Users/tessamoeller/Documents/atoll_paper/data/COWCLIP/Tm/regridded",
)
...
# Example usage
regridded_dir = "../data/COWCLIP/Tm/regridded"

plot_regridded_year(regridded_dir, year=2010, var_to_plot="tm_p90")
...
time_coverage = check_time_extents("../data/COWCLIP/Tm/regridded")
...
# === Run it ===
regridded_dir = "../data/COWCLIP/Tm/regridded"
output_path = "../data/processed/COWCLIP_ensemble_mean_Tm_1995_2014.nc"
...
ds = xr.open_dataset("../data/processed/COWCLIP_ensemble_mean_Tm_1995_2014.nc")
